...
public delegate void NextPlayerEvent (int playerID);

public delegate void GameOverEvent<GameResult> (GameResult result);

public interface IGameInformer<GameResult>
{
    bool Running {get;}
